...
export class StepIndicator extends PureComponent {
  constructor(props) {
    super(props)
    ...
    return (
      <View
        ...
        style={[
          ...
          direction === 'vertical'
            ? { flexDirection: 'column', width: this.customStyles.currentStepIndicatorSize }
    ...
    return (
      <Animated.View key={'step-indicator'} removeClippedSubviews style={[styles.step, stepStyle]}>
        <Text style={indicatorLabelStyle}>
          {this.getStepStatus(position) !== STEP_STATUS.FINISHED ? position + 1 : '√'}
        </Text>
      </Animated.View>
    )
  }
